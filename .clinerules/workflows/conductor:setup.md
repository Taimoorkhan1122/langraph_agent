...
2.  **Select Code Style Guides:**
    -   List the available style guides by running `ls .clinerules/conductor/templates/code_styleguides/`.
...
3.  **Action:** Construct and execute a command to create the directory and copy all selected files. For example: `mkdir -p conductor/code_styleguides && cp .clinerules/conductor/templates/code_styleguides/python.md .clinerules/conductor/templates/code_styleguides/javascript.md conductor/code_styleguides/`
...
1.  **Copy Initial Workflow:**
    -   Copy `.clinerules/conductor/templates/workflow.md` to `conductor/workflow.md`.
2.  **Determine Mode:** Use the `ask_user` tool to let the user choose their preferred workflow.
    - **questions:**
        - **header:** "Workflow"
